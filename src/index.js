...
var col = document.getElementsByName("solut");
...
function checkAllWinners(cols) {
  checkWinnerVertical(cols);
  checkWinnerHorisontal(cols);
}
...
function timeri2() {
  if (timer === 0) {
    var myVar = setInterval(move, 100);
  }
}
